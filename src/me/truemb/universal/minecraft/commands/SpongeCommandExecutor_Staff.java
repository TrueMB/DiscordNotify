...
public class SpongeCommandExecutor_Staff implements Raw {
	...
	public CommandResult process(CommandCause cause, Mutable arguments) throws CommandException {
		...
		this.staffCommand.onCommand(this.instance.getUniversalServer().getPlayer(uuid), arguments.parseString().split(" "));
