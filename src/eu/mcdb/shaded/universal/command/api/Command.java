...
package eu.mcdb.shaded.universal.command.api;
...
import eu.mcdb.shaded.util.ArrayUtils;
...
public class Command extends UniversalCommand {
    ...
    public final boolean onCommand(final UniversalCommandSender sender, final String[] args) {
    	this.onCommandUsed(sender, args);
        if (args.length == 0) {
    ...
    public void onCommandUsed(final UniversalCommandSender sender, final String[] args) {
