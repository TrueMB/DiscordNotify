...
package eu.mcdb.shaded.universal;

import java.lang.annotation.Annotation;
import org.bukkit.plugin.java.JavaPlugin;
import org.spongepowered.api.Sponge;

import eu.mcdb.shaded.minecraft.plugin.SpongePlugin;
import eu.mcdb.shaded.minecraft.plugin.VelocityPlugin;
import eu.mcdb.shaded.universal.command.BukkitCommandExecutor;
import eu.mcdb.shaded.universal.command.BungeeCommandExecutor;
import eu.mcdb.shaded.universal.command.SpongeCommandExecutor;
import eu.mcdb.shaded.universal.command.UniversalCommand;
import eu.mcdb.shaded.universal.command.VelocityCommandExecutor;
