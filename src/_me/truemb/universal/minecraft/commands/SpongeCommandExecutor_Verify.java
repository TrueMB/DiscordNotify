...
public class SpongeCommandExecutor_Verify extends BukkitCommand implements TabCompleter {

	private DiscordNotifyMain instance;
	private DN_VerifyCommand verifyCommand;

	protected SpongeCommandExecutor_Verify(DiscordNotifyMain plugin) {
		super("verify");
